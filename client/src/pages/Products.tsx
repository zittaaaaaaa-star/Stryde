...
export default function ProductsPage() {
  ...
  return (
    <div className="min-h-screen">
      <BrandNavigation />
      <section className="relative py-24 sm:py-32 lg:py-40 bg-muted/20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 justify-items-center">
            {products.map((product) => (
              <div
                key={product.id}
                className="bg-card rounded-xl p-6 sm:p-8 border border-border flex flex-col w-full max-w-md"
              >
          ...
          <div className="max-w-6xl mx-auto mt-12 sm:mt-16 lg:mt-24">
            ...
            <div className="max-w-3xl mx-auto bg-card rounded-xl p-6 sm:p-8 lg:p-12 border border-border">
